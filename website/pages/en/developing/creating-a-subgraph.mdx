...
| 1.0.0 | Supports [`indexerHints`](#indexer-hints) feature to prune subgraphs |
| 0.0.9 | Supports `endBlock` feature |
| 0.0.8 | Added support for polling [Block Handlers](#polling-filter) and [Initialisation Handlers](#once-filter). |
| 0.0.7 | Added support for [File Data Sources](#ipfsarweave-file-data-sources). |
